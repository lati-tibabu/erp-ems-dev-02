...
import { AiLogo2, AiLogo3, ProperLogo2, ProperLogo4 } from '../../components/ems_logo';
...
function PrincipalDashboard() {
    ...
    const attendancePage = '/principal/attendance';
    const profilePage = '/principal/profile';
    const helpPage = '/principal/help';
  ...
  useEffect(() => {
    (location.pathname === '/principal' || location.pathname === '/principal/') && navigate('/principal/home');
  }, []);
        ...
        <RowWrapper style={styles.header_styles}>
          ...
          <RowWrapper style={{ alignItems: 'center', width: '100%', border: 'none' }}>
            <RowWrapper style={{ width: '100%', border: 'none' }}>
              <Heading5 text="Principal Dashboard" style={{ fontWeight: '600' }} />
            </RowWrapper>
