...
function CreateTeacherSpecific (props){
    ...
    const [isClassroomTeacher, setIsClassroomTeacher] = useState({is_classroom_teacher: false});
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                if(window.confirm("The user(teacher) does not have a contand do you want to add one for it?")){
                    navigate('/admin/users/overview/teacher/create/contact/'+response.data.user_id)
                } else{
            ...
            <form onSubmit={handleSubmit}>
                ...
                <ColumnWrapper className='bw-none'>
                    ...
                    <Select 
                        ...
                        onChange={(e) => setTeacherType(prevState => ({...prevState, teacher_type: e.value}))}
                    />
                </ColumnWrapper>
                ...
                <ColumnWrapper className='bw-none'>
                    ...
                    <Select 
                        ...
                        onChange={(e) => setDepartmentID(prev => ({...prev, department_id: e.value}))}
                    />
                </ColumnWrapper>
                ...
                <ColumnWrapper style={{border: 'none'}}>
                    ...
                    <Select 
                        ...
                        onChange={(e) => setSalaryRange(prevState => ({...prevState, salary: e.value}))}
                    />
                </ColumnWrapper>
                ...
                <CheckboxWrapper
                    wrapperName='Is Classroom Teacher'  >
                    <InputField 
                ...
                <ColumnWrapper className='bw-none'>
                    <RowWrapper className='bw-none justify-between align-center'>
                        ...
                        <FontAwesomeIcon icon={`fa-solid fa-chevron-${additionalFields ? 'up' : 'down'}`} onClick={(e) => setAdditionalFields(!additionalFields)} style={{cursor:'pointer'}}/>
                    </RowWrapper> 
                    
                    <ColumnWrapper style={{display: `${additionalFields ? 'flex' : 'none'}`}} >
                        <InputField 
