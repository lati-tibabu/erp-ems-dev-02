...
function StudentDashboard() {
    ...
    const myClassPage = '/student/my-class';
    const myResultPage = '/student/my-result';
    const profilePage = '/student/profile';
    const helpPage = '/student/help';

    const location = useLocation();
    const currentLocation = location.pathname;

    const onHomePage = currentLocation.startsWith(homePage);
    const onMyClassPage = currentLocation.startsWith(myClassPage);
    const onMyResultPage = currentLocation.startsWith(myResultPage);
    ...
    const username = (uname2 && "@" + uname2) || "Student";
    ...
    useEffect(() => {
        (location.pathname === '/student' || location.pathname === '/student/') && navigate('/student/home');
    }, []);
            ...
            <RowWrapper style={styles.header_styles}>
                ...
                <RowWrapper style={{ alignItems: 'center', width: '100%', border: 'none' }}>
                    <RowWrapper style={{ width: '100%', border: 'none' }}>
                        <Heading5 text="Student Dashboard" style={{ fontWeight: '600' }} />
                    </RowWrapper>
            ...
            <RowWrapper style={styles.main_content_container}>
                <ColumnWrapper style={styles.nav_bar_container}>
                    ...
                    <ColumnWrapper style={styles.navigation_button_styles}>
                        ...
                        <RowWrapper style={styles.logout_nav_button_style} onClick={handleLogout}>
